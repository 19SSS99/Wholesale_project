...
<head>
    ...
    <!-- BEGIN: Vendor CSS-->
    <link rel="stylesheet" type="text/css" href="{{asset('public/dashboard/vendors/css/vendors-rtl.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('public/dashboard/vendors/css/extensions/shepherd-theme-default.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('public/dashboard/vendors/css/charts/apexcharts.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('public/dashboard/vendors/css/extensions/tether-theme-arrows.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('public/dashboard/css/vendors/css/tables/datatable/datatables.min.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('public/dashboard/css/core/menu/menu-types/vertical-menu.css')}}">
...
<!-- BEGIN: Header-->
@include('seller.layouts.includes.header')
<!-- END: Header-->


<!-- BEGIN: Main Menu-->
@include('seller.layouts.includes.menu')
<!-- END: Main Menu-->
...
<!-- BEGIN: Footer-->
@include('seller.layouts.includes.footer')
<!-- END: Footer-->
