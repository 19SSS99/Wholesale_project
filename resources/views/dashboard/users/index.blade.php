                                    ...
                                    <table id="myTable" class="table table-striped mb-0">
                                        ...
                                        <?php $i = 0; ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$user->email}}</td>
                                                <td>{{$user->phone}}</td>
                                                <td>@if($user->type==2) seller @else buyer @endif</td>


                                                <td class="text-left">


                                                    <a href="{{route('users.delete', $user->id)}}" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="" onclick="return confirm('Do you Want to delete user?');">
