        ...
        <div class="content-header row">
            ...
            <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
                <div class="form-group breadcrum-right">
                    <a href="{{route('categories.create')}}" class="btn btn-primary mb-2 waves-effect waves-light"><i class="feather icon-plus"></i>&nbsp; create</a>
                </div>
            </div>
                                    ...
                                    <table id="myTable" class="table table-striped mb-0">
                                        ...
                                        <?php $i = 0; ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-left">
                                                    <a class="btn btn-soft-info btn-icon btn-circle btn-sm" href="{{route('categories.edit', $category->id)}}" >
                                                        <i style="color: cornflowerblue"  class="fa fa-edit"></i>
                                                    </a>

                                                    <a href="{{route('categories.delete', $category->id)}}" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="" onclick="return confirm('Do you Want to delete category?');">
